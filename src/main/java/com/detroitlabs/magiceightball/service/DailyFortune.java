...
public class DailyFortune {
    public Fortune fetchDailyFortune() throws IOException {
        ...
        ResponseEntity responseEntity = restTemplate.exchange("https://aztro.sameerkumar.website?sign=leo&day=today", HttpMethod.POST, entity, String.class);
