...
@Controller
public class DealerStayController {
    @Autowired
    private DeckRepository deckRepository;

    @RequestMapping("DealerStay")
    public String DealerStay(ModelMap modelMap) {
        ...
        int dealerhand1 = deckRepository.getDeck().get(2).getValue() + deckRepository.getDeck().get(3).getValue() + deckRepository.getDeck().get(8).getValue();
