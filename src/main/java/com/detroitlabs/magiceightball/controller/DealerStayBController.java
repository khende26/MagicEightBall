...
@Controller
public class DealerStayBController {
    @Autowired
    private DeckRepository deckRepository;

    @RequestMapping("DealerStayB")
    public String DealerStayB(ModelMap modelMap) {
        ...
        Card dealerCard5 = deckRepository.getDeck().get(10);
        String description10 = dealerCard3.describeCard();
        modelMap.put("dealerCard5Description", description10);
        ...
        int dealerhand1 = deckRepository.getDeck().get(2).getValue() + deckRepository.getDeck().get(3).getValue()
                ...
                + deckRepository.getDeck().get(10).getValue();
